"""Application configuration for MCP Agent."""
...
class Settings(BaseSettings):
    ...
    database_url: str = Field(
        default="postgresql+asyncpg://postgres:postgres@localhost:5432/mcp_agent",
    ...
    opensearch_index: str = Field(default="mcp_agent_vectors", description="Index")
    ...
    mcp_server_name: str = Field(default="mcp-agent-mcp", description="MCP server name")

    a2a_discovery_url: str = Field(default="http://localhost:8500", description="A2A discovery URL")
    a2a_agent_id: str = Field(default="mcp-agent", description="A2A agent ID")
